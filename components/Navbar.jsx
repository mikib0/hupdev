...
export default function () {
  ...
  return (
    <nav className='flex items-center justify-between bg-gray py-2 px-4 md:px-dx fixed left-0 right-0 z-20 md:relative'>
      ...
      <div
        ...
        className='absolute top-full md:top-0 bg-gray z-10 shadow-xl shadow-gray-light md:shadow-none pb-3 md:pb-0 px-4 left-0 right-0 transition-all duration-500 grid md:block md:relative text-white'
